...
<head>
	...
	{{-- <link rel="shortcut icon" href="{{asset('assets/auth/media/logos/logo_navbar.svg')}}" /> --}}
							...
							<div class="row g-3 mb-9">
								...
								<div class="col-md-6">
									...
									<a href="{{ url('auth/facebook') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
										<img alt="Logo" src="{{asset('assets/auth/media/svg/brand-logos/facebook-1.svg')}}" class="theme-light-show h-15px me-3" />
