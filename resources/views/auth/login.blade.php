						...
						<form method="POST" action="{{ route('login') }}">
							...
							<div class="fv-row mb-8">
								...
								<div>
									...
									<input class="inp1" id="email" style="width: 100%; padding: 9px;border-radius: 10%; border: 3px solid black; background-color:transparent; color: black;"  class="block mt-1 email-login" type="email" name="email" :value="old('email')" required autofocus />
							...
							<div class="fv-row mb-3">
								...
								<div class="mt-4">
									...
									<input class="inp2" id="password" style="width: 100%; padding: 9px; border-radius: 10%; border: 3px solid black; background-color:transparent; color: black;" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
