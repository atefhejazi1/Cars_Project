        ...
        <div class="row services-item">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 p-lg-0">
                <div class="services-item-inner">
                    ...
                    <img src="{{ asset('images/sparePartsItems/'.$item-> path_image)}}" width="10px" height="200px"  alt="قطعة غيار" />
                    <p>{{ $item-> name }} </p>
                    <div class="star-icon">
        ...
        <div class="row services-item">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 p-lg-0">
                <div class="services-item-inner">
                    ...
                    <img src="{{ asset('images/accessories/'.$accessorie-> path_image)}}" width="10px" height="200px"  alt="قطعة غيار" />
                    <p>{{ $accessorie-> name }}</p>
                    <div class="star-icon">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
        ...
        <div class="row services-item">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 p-lg-0">
                <div class="services-item-inner">
                    ...
                    <img src="{{ asset('images/oils/'.$oil-> path_image)}}"  width="10px" height="200px" alt="قطعة غيار" />
                    <p>{{ $oil-> name }} </p>
                    <div class="star-icon">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
