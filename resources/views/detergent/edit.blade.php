@include('layouts.headerDash')
  ...
  <thead>
    <tr class="text-center">
      ...
      <th scope="col" style="width:200px">اسم المنظف</th>
      <th scope="col" style="width:400px">تفاصيل المنظف</th>
      <th scope="col" style="width:200px">صورة المنظف</th>
      <th scope="col" style="width:300px" >صورة المنظف الجديدة</th>
      <th scope="col" style="width:100px">سعر المنظف</th>
  ...
  <tbody>
    ...
    <tr>
        <form action="{{ route('detergent.update',$detergent->id) }}" method="post"  enctype="multipart/form-data">
            ...
            <td>
                <div class="mb-3">
                <textarea class="form-control" name="description">{{ $detergent->description }}</textarea>
                </div>
            </td>
            <td>

                <div class="mb-3">
                    <img src="{{ asset('images/detergent/'.$detergent-> path_image)}}" width="110px" height="70px" alt="sameh"/>
                </div>
            </td>
            <td>
                <div class="mb-3">
