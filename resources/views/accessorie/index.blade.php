...
<div class="big-div">
  @if ($errors->any())
    <div class="alert alert-danger">
        ...
        <div class=" d-flex justify-content-between mb-5 mt-3">
          <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">اضافة اكسسوار </button>
 ...
 <table class="table align-middle table-row-dashed fs-6 gy-5" style="overflow-x: scroll; margin-right: 23%; text-align: center;" id="kt_ecommerce_products_table">
												<!--begin::Table head-->
												<thead>
													<!--begin::Table row-->
